    ...
    <div class="container">
      <div class="footer__grid">
        <div class="footer__brand">
          <img src="/images/gallery/Asset-1-sm.webp" alt="Emira V Beauty Studio" width="108" height="40" style="height: 40px; width: auto; object-fit: contain;">
          <p>Salon de înfrumusețare: manichiură & pedichiură, coafor & vopsit, cosmetică, tratamente faciale, epilare.</p>
          ...
          <div style="margin-top: 1.5rem; border-radius: 8px; overflow: hidden; height: 160px; max-width: 250px;">
            <iframe loading="lazy" width="100%" height="100%" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?q=Emirav%20Beauty%20Studio%2C%20Strada%20Gr%C4%83dinarilor%2030%2C%20077145%20Pantelimon&t=&z=15&ie=UTF8&iwloc=&output=embed" title="Harta Google Maps - Emira V Beauty Studio"></iframe>
          </div>
        </div>
        <div>
